...
import { DateInterval, OAuthClient, OAuthScope, OAuthToken, OAuthTokenRepository, OAuthUser } from "@jmondi/oauth2-server";
...
export class TokenRepositoryService implements OAuthTokenRepository {
    ...
    async issueRefreshToken(accessToken: OAuthToken, client: OAuthClient): Promise<OAuthToken> {
